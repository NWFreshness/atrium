...
**6.2 Signup page and auto sign-in** — [spec](./features/phase-6-accounts/6.2-signup-page.md) — status: completed, PR open.

Phase 6 Accounts: 6.3–6.4 still specced. Do not start 6.3 until 6.2 merges.
