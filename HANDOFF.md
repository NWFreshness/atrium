...
**Stop. Next work is feature 3.5.** Do not run 3.6 in parallel with 3.5. Do not invent Groove specs. Do not push to `main`.
...
| **3.5 Circles board, cadence, snooze** | **next** |
...
6. `features/phase-3-rolodex/3.5-circles.md` — implement that spec, nothing else
...
Then implement 3.5 from its spec.
