...
**Stop. Next work is feature 2.8.** Do not invent Rolodex/Groove specs. Do not push to `main`.
...
6. `features/phase-2-space/2.8-playwright-smoke.md` — implement that spec, nothing else
...
Then implement 2.8 from its spec.
