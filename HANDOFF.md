...
**Stop. Next work is feature 1.5.** Do not start 1.6+ until 1.5 is done. Do not invent Space/Rolodex/Groove specs. Do not push to `main`.
...
6. `features/phase-1-crm/1.5-deals.md` — implement that spec, nothing else
...
Then implement 1.5 from its spec.
