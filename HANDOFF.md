...
**Stop. Next work is feature 2.4.** Do not start 2.5+ until 2.4 is done. Do not invent Rolodex/Groove specs. Do not push to `main`.
...
6. `features/phase-2-space/2.4-block-editor.md` — implement that spec, nothing else
...
Then implement 2.4 from its spec.
