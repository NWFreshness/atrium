...
**Stop. Next work is feature 4.2.** Do not implement 4.3 while 4.2 is open. Do not push to `main`.
...
6. `features/phase-4-groove/4.2-shell.md` — implement that spec, nothing else
...
Then implement 4.2 from its spec.
