...
**Stop. Nothing is in progress.** 9.3 is complete on this branch (awaiting merge). Do not start 9.4 until 9.3 has a `mergedAt`. Do not push to `main`. Do not merge unless asked.

## Where we are (2026-09-11)

Phases 0–8, 9.1, and 9.2 are complete. 9.3 verifies a dummy bcrypt hash when the login email is unknown. Next is 9.4 after this PR merges. Design: `docs/superpowers/specs/2026-09-11-security-design.md`.
...
6. After 9.3 merges: `features/phase-9-security/9.4-auth-throttle.md`. Do not start 9.4 on this branch.
...
Phase 8 is complete and the dev branch carries every migration (`0000`–`0006`). 9.3 is complete on this branch. After it merges: `git checkout main && git pull`, branch `feat/9.4-auth-throttle`, and implement 9.4 only.
