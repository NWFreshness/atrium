...
**Stop. Next work is feature 2.3.** Do not start 2.4+ until 2.3 is done. Do not invent Rolodex/Groove specs. Do not push to `main`.
...
| **2.3 Pages tree in the sidebar** | **next** |
...
6. `features/phase-2-space/2.3-pages-sidebar.md` — implement that spec, nothing else
...
Then implement 2.3 from its spec.
