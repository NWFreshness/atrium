...
**Stop. Next work is feature 3.9.** Do not run 3.10 in parallel with 3.9. Do not invent Groove specs. Do not push to `main`.
...
6. `features/phase-3-rolodex/3.9-today.md` — implement that spec, nothing else
...
Then implement 3.9 from its spec.
